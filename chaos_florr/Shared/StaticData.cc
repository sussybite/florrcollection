...
uint32_t const MAX_LEVEL = 9999;
uint32_t const TPS = 20;

float const PETAL_DISABLE_DELAY = 45.0f; //seconds
float const PLAYER_ACCELERATION = 10.0f;
float const DEFAULT_FRICTION = 1.0f/16.0f;
...
std::array<struct MobData, MobID::kNumMobs> const MOB_DATA = {{
    ...
    {
        .name = "Hornet",
        .description = "most annoying mob in florr",
        .rarity = RarityID::kUnusual,
        .health = {40.0},
        .damage = 40.0,
        .radius = {40.0},
