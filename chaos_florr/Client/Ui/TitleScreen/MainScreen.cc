...
Element *Ui::make_explode_button() {
    Element *elt = new Ui::Button(50, 50, 
        new Ui::StaticText(16, "Explode"), 
        [](Element *elt, uint8_t e){ if (e == Ui::kClick) Game::explode(); },
        [](){ return Game::in_game() != 0; },
...
Element *Ui::make_github_link_button() {
    Element *elt = new Ui::VContainer({
        new Ui::HContainer({
            new Ui::Button(50, 50, 
                ...
                [](Element *elt, uint8_t e){
                    if (e == Ui::kClick) DOM::open_page("https://triep.io");
                },
                nullptr,
                { .fill = 0xff333333, .line_width = 4, .round_radius = 4 }
            )
        ...
        new Ui::Button(50, 50, 
            ...
            [](Element *elt, uint8_t e){ if (e == Ui::kClick) Game::explode(); },
            [](){ return Game::in_game() != 0; },
            { .fill = 0xffffff00, .line_width = 4, .round_radius = 4 }
        )
