...
void draw_static_petal_single(PetalID::T id, Renderer &ctx) {
    ...
    switch(id) {
        ...
        case PetalID::kTriplet:
            ctx.set_fill(0xffffe600);
            ctx.set_stroke(0xffc9b600);
        ...
        case PetalID::kQRcode:
            ...
            ctx.begin_path();
            ctx.move_to(1.21, 5.35);
            ctx.line_to(1.21, 9.50);
            ctx.line_to(9.50, 9.50);
            ctx.line_to(9.50, 1.21);
            ctx.line_to(1.21, 1.21);
            ctx.line_to(1.21, 5.35);
            ctx.move_to(11.86, 1.79);
            ctx.line_to(11.86, 2.36);
            ctx.line_to(13.07, 2.36);
            ctx.line_to(13.07, 4.72);
            ctx.line_to(11.86, 4.72);
            ctx.line_to(11.86, 3.57);
            ctx.line_to(10.65, 3.57);
            ctx.line_to(10.65, 10.65);
            ctx.line_to(11.86, 10.65);
            ctx.line_to(11.86, 11.86);
            ctx.line_to(9.50, 11.86);
            ctx.line_to(9.50, 10.65);
            ctx.line_to(3.57, 10.65);
            ctx.line_to(3.57, 13.07);
            ctx.line_to(1.21, 13.07);
            ctx.line_to(1.21, 14.21);
            ctx.line_to(4.72, 14.21);
            ctx.line_to(4.72, 15.43);
            ctx.line_to(3.57, 15.43);
            ctx.line_to(3.57, 20.14);
            ctx.line_to(4.72, 20.14);
            ctx.line_to(4.72, 18.93);
            ctx.line_to(5.93, 18.93);
            ctx.line_to(5.93, 17.79);
            ctx.line_to(8.29, 17.79);
            ctx.line_to(8.29, 18.93);
            ctx.line_to(7.14, 18.93);
            ctx.line_to(7.14, 20.14);
            ctx.line_to(5.93, 20.14);
            ctx.line_to(5.93, 21.35);
            ctx.line_to(7.14, 21.35);
            ctx.line_to(7.14, 20.14);
            ctx.line_to(8.29, 20.14);
            ctx.line_to(8.29, 21.35);
            ctx.line_to(9.50, 21.35);
            ctx.line_to(9.50, 20.14);
            ctx.line_to(10.65, 20.14);
            ctx.line_to(10.65, 22.50);
            ctx.line_to(11.86, 22.50);
            ctx.line_to(11.86, 23.71);
            ctx.line_to(10.65, 23.71);
            ctx.line_to(10.65, 28.43);
            ctx.line_to(13.07, 28.43);
            ctx.line_to(13.07, 29.64);
            ctx.line_to(10.65, 29.64);
            ctx.line_to(10.65, 30.79);
            ctx.line_to(13.07, 30.79);
            ctx.line_to(13.07, 29.64);
            ctx.line_to(14.21, 29.64);
            ctx.line_to(14.21, 28.43);
            ctx.line_to(13.07, 28.43);
            ctx.line_to(13.07, 27.28);
            ctx.line_to(14.21, 27.28);
            ctx.line_to(14.21, 26.07);
            ctx.line_to(15.43, 26.07);
            ctx.line_to(15.43, 27.28);
            ctx.line_to(16.57, 27.28);
            ctx.line_to(16.57, 28.43);
            ctx.line_to(15.43, 28.43);
            ctx.line_to(15.43, 30.79);
            ctx.line_to(16.57, 30.79);
            ctx.line_to(16.57, 29.64);
            ctx.line_to(17.79, 29.64);
            ctx.line_to(17.79, 30.79);
            ctx.line_to(18.93, 30.79);
            ctx.line_to(18.93, 29.64);
            ctx.line_to(17.79, 29.64);
            ctx.line_to(17.79, 28.43);
            ctx.line_to(20.14, 28.43);
            ctx.line_to(20.14, 29.64);
            ctx.line_to(21.35, 29.64);
            ctx.line_to(21.35, 28.43);
            ctx.line_to(22.50, 28.43);
            ctx.line_to(22.50, 29.64);
            ctx.line_to(23.71, 29.64);
            ctx.line_to(23.71, 30.79);
            ctx.line_to(30.79, 30.79);
            ctx.line_to(30.79, 22.50);
            ctx.line_to(28.43, 22.50);
            ctx.line_to(28.43, 20.14);
            ctx.line_to(27.28, 20.14);
            ctx.line_to(27.28, 16.57);
            ctx.line_to(28.43, 16.57);
            ctx.line_to(28.43, 18.93);
            ctx.line_to(29.64, 18.93);
            ctx.line_to(29.64, 20.14);
            ctx.line_to(30.79, 20.14);
            ctx.line_to(30.79, 17.79);
            ctx.line_to(29.64, 17.79);
            ctx.line_to(29.64, 16.57);
            ctx.line_to(30.79, 16.57);
            ctx.line_to(30.79, 13.07);
            ctx.line_to(29.64, 13.07);
            ctx.line_to(29.64, 11.86);
            ctx.line_to(28.43, 11.86);
            ctx.line_to(28.43, 10.65);
            ctx.line_to(22.50, 10.65);
            ctx.line_to(22.50, 11.86);
            ctx.line_to(23.71, 11.86);
            ctx.line_to(23.71, 13.07);
            ctx.line_to(24.86, 13.07);
            ctx.line_to(24.86, 11.86);
            ctx.line_to(28.43, 11.86);
            ctx.line_to(28.43, 14.21);
            ctx.line_to(29.64, 14.21);
            ctx.line_to(29.64, 15.43);
            ctx.line_to(27.28, 15.43);
            ctx.line_to(27.28, 16.57);
            ctx.line_to(26.07, 16.57);
            ctx.line_to(26.07, 14.21);
            ctx.line_to(27.28, 14.21);
            ctx.line_to(27.28, 13.07);
            ctx.line_to(26.07, 13.07);
            ctx.line_to(26.07, 14.21);
            ctx.line_to(23.71, 14.21);
            ctx.line_to(23.71, 15.43);
            ctx.line_to(22.50, 15.43);
            ctx.line_to(22.50, 13.07);
            ctx.line_to(21.35, 13.07);
            ctx.line_to(21.35, 11.86);
            ctx.line_to(20.14, 11.86);
            ctx.line_to(20.14, 13.07);
            ctx.line_to(18.93, 13.07);
            ctx.line_to(18.93, 14.21);
            ctx.line_to(17.79, 14.21);
            ctx.line_to(17.79, 15.43);
            ctx.line_to(20.14, 15.43);
            ctx.line_to(20.14, 14.21);
            ctx.line_to(21.35, 14.21);
            ctx.line_to(21.35, 16.57);
            ctx.line_to(20.14, 16.57);
            ctx.line_to(20.14, 17.79);
            ctx.line_to(18.93, 17.79);
            ctx.line_to(18.93, 16.57);
            ctx.line_to(15.43, 16.57);
            ctx.line_to(15.43, 15.43);
            ctx.line_to(16.57, 15.43);
            ctx.line_to(16.57, 14.21);
            ctx.line_to(15.43, 14.21);
            ctx.line_to(15.43, 15.43);
            ctx.line_to(14.21, 15.43);
            ctx.line_to(14.21, 14.21);
            ctx.line_to(13.07, 14.21);
            ctx.line_to(13.07, 11.86);
            ctx.line_to(16.57, 11.86);
            ctx.line_to(16.57, 10.65);
            ctx.line_to(17.79, 10.65);
            ctx.line_to(17.79, 11.86);
            ctx.line_to(18.93, 11.86);
            ctx.line_to(18.93, 10.65);
            ctx.line_to(17.79, 10.65);
            ctx.line_to(17.79, 9.50);
            ctx.line_to(18.93, 9.50);
            ctx.line_to(18.93, 8.29);
            ctx.line_to(20.14, 8.29);
            ctx.line_to(20.14, 10.65);
            ctx.line_to(21.35, 10.65);
            ctx.line_to(21.35, 7.14);
            ctx.line_to(20.14, 7.14);
            ctx.line_to(20.14, 5.93);
            ctx.line_to(16.57, 5.93);
            ctx.line_to(16.57, 7.14);
            ctx.line_to(13.07, 7.14);
            ctx.line_to(13.07, 5.93);
            ctx.line_to(14.21, 5.93);
            ctx.line_to(14.21, 4.72);
            ctx.line_to(15.43, 4.72);
            ctx.line_to(15.43, 3.57);
            ctx.line_to(14.21, 3.57);
            ctx.line_to(14.21, 2.36);
            ctx.line_to(15.43, 2.36);
            ctx.line_to(15.43, 1.21);
            ctx.line_to(14.21, 1.21);
            ctx.line_to(14.21, 2.36);
            ctx.line_to(13.07, 2.36);
            ctx.line_to(13.07, 1.21);
            ctx.line_to(11.86, 1.21);
            ctx.line_to(11.86, 1.79);
            ctx.move_to(18.93, 1.79);
            ctx.line_to(18.93, 2.36);
            ctx.line_to(21.35, 2.36);
            ctx.line_to(21.35, 1.21);
            ctx.line_to(18.93, 1.21);
            ctx.line_to(18.93, 1.79);
            ctx.move_to(22.50, 5.35);
            ctx.line_to(22.50, 9.50);
            ctx.line_to(30.79, 9.50);
            ctx.line_to(30.79, 1.21);
            ctx.line_to(22.50, 1.21);
            ctx.line_to(22.50, 5.35);
            ctx.move_to(2.36, 5.32);
            ctx.line_to(2.36, 8.29);
            ctx.line_to(8.29, 8.29);
            ctx.line_to(8.29, 2.36);
            ctx.line_to(2.36, 2.36);
            ctx.line_to(2.36, 5.32);
            ctx.move_to(23.71, 5.32);
            ctx.line_to(23.71, 8.29);
            ctx.line_to(29.64, 8.29);
            ctx.line_to(29.64, 2.36);
            ctx.line_to(23.71, 2.36);
            ctx.line_to(23.71, 5.32);
            ctx.move_to(3.57, 5.35);
            ctx.line_to(3.57, 7.14);
            ctx.line_to(7.14, 7.14);
            ctx.line_to(7.14, 3.57);
            ctx.line_to(3.57, 3.57);
            ctx.line_to(3.57, 5.35);
            ctx.move_to(17.79, 4.14);
            ctx.line_to(17.79, 4.72);
            ctx.line_to(18.93, 4.72);
            ctx.line_to(18.93, 3.57);
            ctx.line_to(17.79, 3.57);
            ctx.line_to(17.79, 4.14);
            ctx.move_to(20.14, 4.14);
            ctx.line_to(20.14, 4.72);
            ctx.line_to(21.35, 4.72);
            ctx.line_to(21.35, 3.57);
            ctx.line_to(20.14, 3.57);
            ctx.line_to(20.14, 4.14);
            ctx.move_to(24.86, 5.35);
            ctx.line_to(24.86, 7.14);
            ctx.line_to(28.43, 7.14);
            ctx.line_to(28.43, 3.57);
            ctx.line_to(24.86, 3.57);
            ctx.line_to(24.86, 5.35);
            ctx.move_to(11.86, 8.89);
            ctx.line_to(11.86, 9.50);
            ctx.line_to(13.07, 9.50);
            ctx.line_to(13.07, 8.29);
            ctx.line_to(11.86, 8.29);
            ctx.line_to(11.86, 8.89);
            ctx.move_to(14.21, 8.89);
            ctx.line_to(14.21, 9.50);
            ctx.line_to(15.43, 9.50);
            ctx.line_to(15.43, 8.29);
            ctx.line_to(14.21, 8.29);
            ctx.line_to(14.21, 8.89);
            ctx.move_to(16.57, 8.89);
            ctx.line_to(16.57, 9.50);
            ctx.line_to(17.79, 9.50);
            ctx.line_to(17.79, 8.29);
            ctx.line_to(16.57, 8.29);
            ctx.line_to(16.57, 8.89);
            ctx.move_to(1.21, 11.25);
            ctx.line_to(1.21, 11.86);
            ctx.line_to(2.36, 11.86);
            ctx.line_to(2.36, 10.65);
            ctx.line_to(1.21, 10.65);
            ctx.line_to(1.21, 11.25);
            ctx.move_to(7.14, 12.46);
            ctx.line_to(7.14, 13.07);
            ctx.line_to(5.93, 13.07);
            ctx.line_to(5.93, 14.21);
            ctx.line_to(7.14, 14.21);
            ctx.line_to(7.14, 15.43);
            ctx.line_to(4.72, 15.43);
            ctx.line_to(4.72, 16.57);
            ctx.line_to(7.14, 16.57);
            ctx.line_to(7.14, 15.43);
            ctx.line_to(9.50, 15.43);
            ctx.line_to(9.50, 16.57);
            ctx.line_to(8.29, 16.57);
            ctx.line_to(8.29, 17.79);
            ctx.line_to(9.50, 17.79);
            ctx.line_to(9.50, 16.57);
            ctx.line_to(10.65, 16.57);
            ctx.line_to(10.65, 17.79);
            ctx.line_to(11.86, 17.79);
            ctx.line_to(11.86, 20.14);
            ctx.line_to(13.07, 20.14);
            ctx.line_to(13.07, 21.35);
            ctx.line_to(14.21, 21.35);
            ctx.line_to(14.21, 22.50);
            ctx.line_to(16.57, 22.50);
            ctx.line_to(16.57, 23.71);
            ctx.line_to(15.43, 23.71);
            ctx.line_to(15.43, 26.07);
            ctx.line_to(18.93, 26.07);
            ctx.line_to(18.93, 24.86);
            ctx.line_to(17.79, 24.86);
            ctx.line_to(17.79, 23.71);
            ctx.line_to(20.14, 23.71);
            ctx.line_to(20.14, 22.50);
            ctx.line_to(18.93, 22.50);
            ctx.line_to(18.93, 21.35);
            ctx.line_to(20.14, 21.35);
            ctx.line_to(20.14, 18.93);
            ctx.line_to(21.35, 18.93);
            ctx.line_to(21.35, 20.14);
            ctx.line_to(23.71, 20.14);
            ctx.line_to(23.71, 18.93);
            ctx.line_to(24.86, 18.93);
            ctx.line_to(24.86, 20.14);
            ctx.line_to(26.07, 20.14);
            ctx.line_to(26.07, 21.35);
            ctx.line_to(27.28, 21.35);
            ctx.line_to(27.28, 20.14);
            ctx.line_to(26.07, 20.14);
            ctx.line_to(26.07, 18.93);
            ctx.line_to(24.86, 18.93);
            ctx.line_to(24.86, 17.79);
            ctx.line_to(26.07, 17.79);
            ctx.line_to(26.07, 16.57);
            ctx.line_to(24.86, 16.57);
            ctx.line_to(24.86, 15.43);
            ctx.line_to(23.71, 15.43);
            ctx.line_to(23.71, 16.57);
            ctx.line_to(22.50, 16.57);
            ctx.line_to(22.50, 17.79);
            ctx.line_to(20.14, 17.79);
            ctx.line_to(20.14, 18.93);
            ctx.line_to(17.79, 18.93);
            ctx.line_to(17.79, 20.14);
            ctx.line_to(16.57, 20.14);
            ctx.line_to(16.57, 21.35);
            ctx.line_to(15.43, 21.35);
            ctx.line_to(15.43, 18.93);
            ctx.line_to(16.57, 18.93);
            ctx.line_to(16.57, 17.79);
            ctx.line_to(15.43, 17.79);
            ctx.line_to(15.43, 16.57);
            ctx.line_to(14.21, 16.57);
            ctx.line_to(14.21, 15.43);
            ctx.line_to(13.07, 15.43);
            ctx.line_to(13.07, 14.21);
            ctx.line_to(11.86, 14.21);
            ctx.line_to(11.86, 13.07);
            ctx.line_to(9.50, 13.07);
            ctx.line_to(9.50, 11.86);
            ctx.line_to(7.14, 11.86);
            ctx.line_to(7.14, 12.46);
            ctx.move_to(7.14, 13.64);
            ctx.line_to(7.14, 14.21);
            ctx.line_to(9.50, 14.21);
            ctx.line_to(9.50, 15.43);
            ctx.line_to(11.86, 15.43);
            ctx.line_to(11.86, 16.57);
            ctx.line_to(13.07, 16.57);
            ctx.line_to(13.07, 15.43);
            ctx.line_to(11.86, 15.43);
            ctx.line_to(11.86, 14.21);
            ctx.line_to(9.50, 14.21);
            ctx.line_to(9.50, 13.07);
            ctx.line_to(7.14, 13.07);
            ctx.line_to(7.14, 13.64);
            ctx.move_to(1.21, 18.96);
            ctx.line_to(1.21, 21.35);
            ctx.line_to(2.36, 21.35);
            ctx.line_to(2.36, 16.57);
            ctx.line_to(1.21, 16.57);
            ctx.line_to(1.21, 18.96);
            ctx.move_to(23.71, 17.18);
            ctx.line_to(23.71, 17.79);
            ctx.line_to(22.50, 17.79);
            ctx.line_to(22.50, 18.93);
            ctx.line_to(23.71, 18.93);
            ctx.line_to(23.71, 17.79);
            ctx.line_to(24.86, 17.79);
            ctx.line_to(24.86, 16.57);
            ctx.line_to(23.71, 16.57);
            ctx.line_to(23.71, 17.18);
            ctx.move_to(8.29, 19.54);
            ctx.line_to(8.29, 20.14);
            ctx.line_to(9.50, 20.14);
            ctx.line_to(9.50, 18.93);
            ctx.line_to(8.29, 18.93);
            ctx.line_to(8.29, 19.54);
            ctx.move_to(17.79, 20.75);
            ctx.line_to(17.79, 21.35);
            ctx.line_to(18.93, 21.35);
            ctx.line_to(18.93, 20.14);
            ctx.line_to(17.79, 20.14);
            ctx.line_to(17.79, 20.75);
            ctx.move_to(21.35, 23.11);
            ctx.line_to(21.35, 24.86);
            ctx.line_to(24.86, 24.86);
            ctx.line_to(24.86, 21.35);
            ctx.line_to(21.35, 21.35);
            ctx.line_to(21.35, 23.11);
            ctx.move_to(1.21, 26.65);
            ctx.line_to(1.21, 30.79);
            ctx.line_to(9.50, 30.79);
            ctx.line_to(9.50, 22.50);
            ctx.line_to(1.21, 22.50);
            ctx.line_to(1.21, 26.65);
            ctx.move_to(22.50, 23.11);
            ctx.line_to(22.50, 23.71);
            ctx.line_to(23.71, 23.71);
            ctx.line_to(23.71, 22.50);
            ctx.line_to(22.50, 22.50);
            ctx.line_to(22.50, 23.11);
            ctx.move_to(2.36, 26.68);
            ctx.line_to(2.36, 29.64);
            ctx.line_to(8.29, 29.64);
            ctx.line_to(8.29, 23.71);
            ctx.line_to(2.36, 23.71);
            ctx.line_to(2.36, 26.68);
            ctx.move_to(11.86, 25.50);
            ctx.line_to(11.86, 27.28);
            ctx.line_to(13.07, 27.28);
            ctx.line_to(13.07, 26.07);
            ctx.line_to(14.21, 26.07);
            ctx.line_to(14.21, 23.71);
            ctx.line_to(11.86, 23.71);
            ctx.line_to(11.86, 25.50);
            ctx.move_to(27.28, 24.29);
            ctx.line_to(27.28, 24.86);
            ctx.line_to(28.43, 24.86);
            ctx.line_to(28.43, 26.07);
            ctx.line_to(29.64, 26.07);
            ctx.line_to(29.64, 23.71);
            ctx.line_to(27.28, 23.71);
            ctx.line_to(27.28, 24.29);
            ctx.move_to(3.57, 26.65);
            ctx.line_to(3.57, 28.43);
            ctx.line_to(7.14, 28.43);
            ctx.line_to(7.14, 24.86);
            ctx.line_to(3.57, 24.86);
            ctx.line_to(3.57, 26.65);
            ctx.move_to(23.71, 26.68);
            ctx.line_to(23.71, 27.28);
            ctx.line_to(22.50, 27.28);
            ctx.line_to(22.50, 28.43);
            ctx.line_to(23.71, 28.43);
            ctx.line_to(23.71, 27.28);
            ctx.line_to(24.86, 27.28);
            ctx.line_to(24.86, 28.43);
            ctx.line_to(27.28, 28.43);
            ctx.line_to(27.28, 29.64);
            ctx.line_to(29.64, 29.64);
            ctx.line_to(29.64, 27.28);
            ctx.line_to(28.43, 27.28);
            ctx.line_to(28.43, 28.43);
            ctx.line_to(27.28, 28.43);
            ctx.line_to(27.28, 26.07);
            ctx.line_to(26.07, 26.07);
            ctx.line_to(26.07, 27.28);
            ctx.line_to(24.86, 27.28);
            ctx.line_to(24.86, 26.07);
            ctx.line_to(23.71, 26.07);
            ctx.line_to(23.71, 26.68);
            ctx.move_to(20.14, 27.86);
            ctx.line_to(20.14, 28.43);
            ctx.line_to(21.35, 28.43);
            ctx.line_to(21.35, 27.28);
            ctx.line_to(20.14, 27.28);
            ctx.line_to(20.14, 27.86);
            ctx.fill();
            break;
        case PetalID::k67:
            ctx.set_fill(0x00000000);
