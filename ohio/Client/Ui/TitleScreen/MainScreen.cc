...
Element *Ui::make_title_input_box() {
    Ui::Element *title = new Ui::VContainer({
        new Ui::Element(0, 60),
        new Ui::Choose(
            new Ui::StaticText(40, "rizzing..."),
            new Ui::VContainer({
                new Ui::StaticText(20, "This sussy little rizzler is called..."),
                new Ui::HContainer({
        ...
        new Ui::Element(0,20),
        new Ui::StaticText(16, "ƒ¬®®≥ˆø"),
    }, 0, 0, { .animate = [](Element *elt, Renderer &ctx){}, .should_render = [](){ return Game::should_render_title_ui(); }, .fill = 0xffff0000 });
    return title;
}
    ...
    Element *elt = new Ui::HContainer({
        new Ui::Button(50, 50, 
            ...
            [](Element *elt, uint8_t e){
                if (e == Ui::kClick) DOM::open_page("https://guthib.com");
            },
            nullptr,
