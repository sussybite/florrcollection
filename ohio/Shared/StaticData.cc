...
std::array<struct PetalData, PetalID::kNumPetals> const PETAL_DATA = {{
    ...
    {
        .name = "QRcode",
        .description = "A QR code. It's not very useful, but it's interesting.",
        .health = 67.0,
        .damage = 67.0,
        .radius = 10.0,
        .reload = 2.5,
    ...
    {
        .name = "67",
        .description = "67 is a special number.",
        .health = 67.0,
        .damage = 67.0,
        .radius = 67.0,
        .reload = 2.5,
...
std::array<struct MobData, MobID::kNumMobs> const MOB_DATA = {{
    ...
    },
    {
        ...
        .xp = 4,
        .drops = {
            PetalID::kLight, PetalID::kStinger, PetalID::kTwin, PetalID::kWing, PetalID::kQRcode, PetalID::k67
        },
        .attributes = {}
    },
    {
    ...
    },
    {
        ...
        .xp = 1,
        .drops = {
            PetalID::kHeavy, PetalID::kLight, PetalID::kRock, PetalID::kQRcode
        },
        .attributes = {
            .stationary = 1
        }
